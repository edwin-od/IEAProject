...
class IsolatedFeatures:
    def __init__(this, landmarks):
        ...
        this.LeftUnderEye = np.array([
            ...
            [landmarks.part(39).x, landmarks.part(28).y],
            [landmarks.part(36).x, landmarks.part(28).y]
        ])
        this.RightUnderEye = np.array([
            ...
            [landmarks.part(45).x, landmarks.part(28).y],
            [landmarks.part(42).x, landmarks.part(28).y]
        ])
